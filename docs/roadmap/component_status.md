...
| BT capability layer / first BT mission | P0 | V25-06 First BT Mission IMPLEMENTED: allowlisted BT backend, project Action composition, structured blockers, safe task identity/hash checks, and bounded cancellation. Fake integration validated; vehicle validation pending. |
