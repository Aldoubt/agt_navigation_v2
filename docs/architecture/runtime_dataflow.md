...
Unit/contract validation and the V25-07 fake full-chain
integration are complete; vehicle validation remains pending.
The sequential backend remains the default.
